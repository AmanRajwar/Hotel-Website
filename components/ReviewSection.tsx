...
const ReviewSection = () => {
  ...
  return (
    <section className='   relative w-full h-[110vh] gradient1 flex max-xl:flex-col gap-[30px] justify-between items-center overflow-hidden xl:items-center xl:flex ' >
