...
const ReviewSection = () => {
  ...
  return (
    <section className='   relative w-full h-[100vh] gradient1 flex max-xl:flex-col gap-[30px] justify-between items-center overflow-hidden xl:items-center xl:flex ' >
      <div className=' lines2 w-full h-full absolute top-0 left-0'></div>
      <div className=' z-50 h-1/2 max-xl:mt-[100px] lg:ml-[50px] 2xl:ml-[100px] max-sm:w-[380px] sm:w-[490px]  md:w-[610px] 2xl:w-[725px] text-white  shadow2 mt-[50px] overflow-hidden px-2'>
      ...
      <div ref={scrollContainerRef} className='overflow-auto w-[40%] max-sm:w-full max-xl:mb-[80px] xl:mr-[50px]  2xl:mr-[100px] flex gap-8 xl:gap-10 xl:flex-col xl:justify-center items-center xl:items-end h-[42%] xl:h-full px-[20px] max-xl:w-[94%] z-0  '>
